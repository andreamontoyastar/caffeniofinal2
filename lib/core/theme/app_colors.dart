...
abstract final class AppColors {
  ...
  static const Color tertiaryLight = Color(0xFFFF8A65);
...
final class _DarkColors {
  ...
  Color get onPrimary => const Color(0xFF1B0000);
  Color get onPrimaryContainer => const Color(0xFFFFDAD6);

  // ── Secundarios dark ──────────────────────────────────────────────────────
  Color get secondary => const Color(0xFFD7CCC8);
  Color get secondaryContainer => const Color(0xFF4E342E);
  Color get onSecondary => const Color(0xFF1B0A06);
  Color get onSecondaryContainer => const Color(0xFFEFEBE9);

  // ── Terciarios dark ───────────────────────────────────────────────────────
  Color get tertiary => const Color(0xFFFFCC80);
  Color get tertiaryContainer => const Color(0xFF6D3B00);
  Color get onTertiary => const Color(0xFF2A1400);
  ...
  Color get outline => const Color(0xFF8E8E93);
  Color get outlineVariant => const Color(0xFF48484A);
